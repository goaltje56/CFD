...
Computational Fluid Dynamics (CFD) is used to solve the system of equations. For this particular problem, the mass, momentum \textcolor{cyan}{energy?} and transport equations are solved. The simulations are performed for fully developed turbulent and incompressible flows. The turbulence is modelled by means of a $\kappa-\epsilon$ model.\\
\newline
